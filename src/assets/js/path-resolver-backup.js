...
(function() {
    ...
    // تابع برای اضافه کردن فایل‌ها پس از آماده شدن DOM
    function addFiles() {
        ...
        jsFiles.forEach(function(file) {
            if (!isFileIncluded(file)) {
                ...
                script.defer = true;
                // بررسی وجود document.body قبل از appendChild
                if (document.body) {
                    document.body.appendChild(script);
                } else {
                    // اگر body هنوز آماده نیست، به head اضافه می‌کنیم
    ...
    if (document.readyState === 'loading') {
        ...
        document.addEventListener('DOMContentLoaded', addFiles);
    } else {
        // DOM آماده است
        addFiles();
    }
